...
import userDefinedLibraries.ExceptionalHandling;
...
public class UrbanLadder {
	...
	void operationCategoryMenu(String browser) {
		...
		try {
			...
			ExceptionalHandling.popupException(e);
		}
	}
	...
	void operationPriceSelect(String browser) {
